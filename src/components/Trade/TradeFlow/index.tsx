...
const TradeFlow = () => {
  ...
  return (
    <div className="hidden col-span-1 xl:flex flex-col border-l border-secondary-gray text-[1.2rem] min-w-[272.5px] w-[272.5px] h-fit">
      <h1 className="font-medium text-sm/5 p-4">Trade Flow {isFetching && "..."}</h1>
      <Separator />
      <div className="flex flex-col pt-3 pl-3 min-h-[373px] max-h-[calc(100vh-425px)] overflow-hidden">
        {/* Layout Selections */}
